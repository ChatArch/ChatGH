...
- 会话展示以 PR 为中心：会话资源通过 GitHub GraphQL PR 节点补全，URL 显示为 `https://github.com/octocat/Hello-World/pull/NUMBER/agent-sessions/SESSION_ID`。
...
```bash
# 为代理任务创建 issue。
gh issue create --repo octocat/Hello-World --title "代理任务" --body "Please investigate ..."
